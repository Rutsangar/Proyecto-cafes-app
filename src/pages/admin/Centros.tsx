...
export default function Centros() {
  ...
  return (
    <div className={cn(
      // --- MAGIA APLICADA AQUÍ ---
      // fixed inset-0 y overscroll-none bloquean la pantalla. flex flex-col estructura.
      ...
      {/* HEADER EXACTO (shrink-0 para que no se encoja ni mueva) */}
            ...
            <div key={centro.id} className="relative">
              <div className={cn(
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className={cn("font-bold text-lg", isDark ? "text-[#F5EBDC]" : "text-[#4E342E]")}>{centro.nombre}</p>
              ...
              {menuAbierto === centro.id && (
                <div className={cn(
                  ...
                  isDark ? "bg-[#1A120B] border border-[#F5EBDC]/10" : "bg-[#FFFFFF] border border-[#4E342E]/10"
                )}>
