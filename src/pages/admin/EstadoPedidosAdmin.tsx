...
const pedidosIniciales: Pedido[] = [
  {
    ...
    cliente: "Pepito",
    estado: "ACEPTADO",
    items: [{ nombre: "Bocadillo", precio: 1.5, img: "" }],
  },
  {
    id: "5678",
    cliente: "Manolo",
    estado: "ACEPTADO",
    items: [{ nombre: "Bocadillo", precio: 1.7, img: "" }],
  },
  {
    id: "9012",
    cliente: "Ana",
    estado: "ACEPTADO",
    items: [{ nombre: "Café", precio: 1.1, img: "" }],
  },
  {
    id: "3456",
    cliente: "Luis",
    estado: "ACEPTADO",
    items: [{ nombre: "Refresco", precio: 1.2, img: "" }],
  },
];
          ...
          {pedidos.map((pedido, index) => (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3
                    className={cn("font-bold text-lg leading-none", textMain)}
                  >
                    Pedido {index + 1}
                  </h3>
                  <span
